...
void Demo::Init() {
	...
	BuildColoredPenyanggakasur();

	BuildColoredPintu();

	BuildColoredKomputer();

	BuildColoredLayar();

	BuildColoredKeyboard();

	BuildColoredBodykeyboard();

	BuildColoredMouse();

	BuildColoredCPU();

	BuildColoredDepanCPU();

	BuildColoredLemari();

	BuildColoredDepanLemari();

	BuildColoredLukisan1();

	BuildColoredLukisan2();
...
void Demo::Render() {
	...
	// point light 1
	glUniform3f(glGetUniformLocation(this->shaderProgram, "pointLights[0].position"), 1.0f, 5.0f, -4.5f);
	...
	glUniform1f(glGetUniformLocation(this->shaderProgram, "pointLights[0].linear"), 0.22f);
	glUniform1f(glGetUniformLocation(this->shaderProgram, "pointLights[0].quadratic"), 0.1f);

	// point light 2
	glUniform3f(glGetUniformLocation(this->shaderProgram, "pointLights[1].position"), 1.0f, 5.0f, -4.5f);
	glUniform3f(glGetUniformLocation(this->shaderProgram, "pointLights[1].ambient"), 1.0f, 1.0f, 1.0f);
	...
	glUniform1f(glGetUniformLocation(this->shaderProgram, "pointLights[1].linear"), 0.22f);
	glUniform1f(glGetUniformLocation(this->shaderProgram, "pointLights[1].quadratic"), 0.1f);

	// point light 3
	glUniform3f(glGetUniformLocation(this->shaderProgram, "pointLights[2].position"), 1.0f, 5.0f, -4.5f);
	glUniform3f(glGetUniformLocation(this->shaderProgram, "pointLights[2].ambient"), 1.0f, 1.0f, 1.0f);
	...
	glUniform1f(glGetUniformLocation(this->shaderProgram, "pointLights[2].linear"), 0.22f);
	glUniform1f(glGetUniformLocation(this->shaderProgram, "pointLights[2].quadratic"), 0.1f);

	// point light 4
	glUniform3f(glGetUniformLocation(this->shaderProgram, "pointLights[3].position"), 1.0f, 5.0f, -4.5f);
	glUniform3f(glGetUniformLocation(this->shaderProgram, "pointLights[3].ambient"), 1.0f, 1.0f, 1.0f);
	...
	glUniform1f(glGetUniformLocation(this->shaderProgram, "pointLights[3].linear"), 0.75f);
	glUniform1f(glGetUniformLocation(this->shaderProgram, "pointLights[3].quadratic"), 0.1f);

	glEnable(GL_BLEND);
	glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);

	DrawColoredDrawerTop();
...
void Demo::DrawColoredRoom()
{
	...
	glBindVertexArray(VAO0); // seeing as we only have a single VAO there's no need to bind it every time, but we'll do so to keep things a bit more organized

	glm::mat4 model;
	model = glm::translate(model, glm::vec3(1, 0, -5));
	model = glm::scale(model, glm::vec3(10, 13, 15));
...
void Demo::DrawColoredCube()
{
	...
	model = glm::scale(model, glm::vec3(3.5, 0.1, 1.5));
	...
	/*for (int i = 0; i < 4; i++) {
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(1.5, 1+i*0.3, 0));
	...
	//Kaki 1 kanan
	glm::mat4 model2;
	model2 = glm::translate(model2, glm::vec3(1.5, -0.1, 0.5));
	model2 = glm::scale(model2, glm::vec3(0.1, 1.3, 0.2));
	...
	//Kaki 2 kanan
	glm::mat4 model3;
	model3 = glm::translate(model3, glm::vec3(1.5, -0.1, -0.5));
	model3 = glm::scale(model3, glm::vec3(0.1, 1.3, 0.2));
	...
	//Kaki 1 kiri
	glm::mat4 model4;
	model4 = glm::translate(model4, glm::vec3(-1.5, -0.1, 0.5));
	model4 = glm::scale(model4, glm::vec3(0.1, 1.3, 0.2));
	...
	//Kaki 2 kiri
	glm::mat4 model5;
	model5 = glm::translate(model5, glm::vec3(-1.5, -0.1, -0.5));
	model5 = glm::scale(model5, glm::vec3(0.1, 1.3, 0.2));
...
void Demo::DrawColoredKursi()
{
	...
	//Atas Kursi
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0, 0.25, -1.2));
	...
	//Kaki Belakang kanan
	glm::mat4 model2;
	model2 = glm::translate(model2, glm::vec3(0.45, -0.1, -1.65));
	model2 = glm::scale(model2, glm::vec3(0.1, 2.3, 0.1));
	...
	//Kaki Depan kanan
	glm::mat4 model3;
	model3 = glm::translate(model3, glm::vec3(-0.45, -0.1, -1.65));
	model3 = glm::scale(model3, glm::vec3(0.1, 2.3, 0.1));
	...
	//Kaki Belakang kiri
	glm::mat4 model4;
	model4 = glm::translate(model4, glm::vec3(0.45, -0.1, -0.75));
	model4 = glm::scale(model4, glm::vec3(0.1, 0.8, 0.1));
	...
	//Kaki Depan kiri
	glm::mat4 model5;
	model5 = glm::translate(model5, glm::vec3(-0.45, -0.1, -0.75));
	model5 = glm::scale(model5, glm::vec3(0.1, 0.8, 0.1));
	...
	//Senderan
	glm::mat4 model6;
	model6 = glm::translate(model6, glm::vec3(0, 0.9, -1.65));
	model6 = glm::scale(model6, glm::vec3(0.8, 0.3, 0.1));
...
void Demo::DrawColoredKasur()
{
	...
	//Body Kasur
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0, -0.5, -9.3));
	model = glm::scale(model, glm::vec3(4, 1.5, 6));
...
void Demo::BuildColoredBantal() {
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("bantal.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredBantal()
{
	...
	//Body Bantal 1
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(1, 0.35, -11.6));
	model = glm::scale(model, glm::vec3(1.5, 0.2, 1));
	...
	//Body Bantal 2
	glm::mat4 model2;
	model2 = glm::translate(model2, glm::vec3(-1, 0.35, -11.6));
	model2 = glm::scale(model2, glm::vec3(1.5, 0.2, 1));
...
//-----------BUILD PENYANGGA KASUR
void Demo::BuildColoredPenyanggakasur() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("penyanggaKasur.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredPenyanggakasur()
{
	glUseProgram(shaderProgram);
	...
	for (int i = 1; i < 5; i++) {
		...
		if (i == 1) {
			model = glm::translate(model, glm::vec3(-2.05, -0.4, -9.3));
			model = glm::scale(model, glm::vec3(0.1, 1.3, 6));
		}
		else if (i == 2) {
			model = glm::translate(model, glm::vec3(2.05, -0.4, -9.3));
			model = glm::scale(model, glm::vec3(0.1, 1.3, 6));
			...
			model = glm::translate(model, glm::vec3(0, -0.4, -6.25));
			model = glm::scale(model, glm::vec3(4.2, 1.3, 0.1));
		}
		else if (i == 4) {
			model = glm::translate(model, glm::vec3(0, -0.4, -12.35));
			model = glm::scale(model, glm::vec3(4.2, 1.3, 0.1));
		}
...
void Demo::DrawColoredPintu()
{
	...
	//Body Pintu
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(6, 1.5, -8));
	model = glm::scale(model, glm::vec3(0.2, 4, 2));
...
//-----------BUILD KOMPUTER
void Demo::BuildColoredKomputer() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("komputerBody.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredKomputer()
{
	...
	for (int i = 1; i < 4; i++) {
		...
		if (i == 1) {
			...
			model = glm::scale(model, glm::vec3(1, 0.8, 0.1));
		}
		else if (i == 2) {
			model = glm::translate(model, glm::vec3(0, 1, 0.1));
			model = glm::scale(model, glm::vec3(0.3, 0.8, 0.1));
		}
		else if (i == 3) {
			model = glm::translate(model, glm::vec3(0, 0.6, 0.1));
			model = glm::scale(model, glm::vec3(1, 0.1, 0.3));
		}
...
//-----------BUILD LAYAR KOMPUTER
void Demo::BuildColoredLayar() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
...
void Demo::DrawColoredLayar()
{
	...
	//Layar Komputer
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0, 1.2, -0.06));
	model = glm::scale(model, glm::vec3(0.9, 0.7, 0));
...
//-----------BUILD KEYBOARD
void Demo::BuildColoredKeyboard() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("keyboard.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredKeyboard()
{
	...
	//Keyboard
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0, 0.6, -0.48));
	model = glm::scale(model, glm::vec3(1, 0.05, 0.5));
...
//-----------BUILD BODY KEYBOARD
void Demo::BuildColoredBodykeyboard() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("komputer.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredBodykeyboard()
{
	glUseProgram(shaderProgram);
	...
	for (int i = 1; i < 5; i++) {
		...
		if (i == 1) {
			model = glm::translate(model, glm::vec3(0.5, 0.6, -0.48));
			model = glm::scale(model, glm::vec3(0.01, 0.05, 0.5));
		}
		else if (i == 2) {
			model = glm::translate(model, glm::vec3(-0.5, 0.6, -0.48));
			model = glm::scale(model, glm::vec3(0.01, 0.05, 0.5));
			...
			model = glm::translate(model, glm::vec3(0, 0.6, -0.23));
			model = glm::scale(model, glm::vec3(1, 0.05, 0.01));
		}
		else if (i == 4) {
			model = glm::translate(model, glm::vec3(0, 0.6, -0.73));
			model = glm::scale(model, glm::vec3(1, 0.05, 0.01));
		}
...
void Demo::BuildColoredMouse() {
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("mouse.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredMouse()
{
	...
	//Mouse
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-0.7, 0.6, -0.48));
	model = glm::scale(model, glm::vec3(0.12, 0.03, 0.17));
...
void Demo::BuildColoredCPU() {
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("cpu.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredCPU()
{
	...
	//Body CPU
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(1.13, 0.96, -0.06));
	model = glm::scale(model, glm::vec3(0.5, 0.8, 1));
...
//-----------BUILD DEPAN CPU
void Demo::BuildColoredDepanCPU() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("depanCPU.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredDepanCPU()
{
	...
	//Depan CPU
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(1.13, 0.96, -0.563));
	model = glm::scale(model, glm::vec3(0.5, 0.8, 0));
...
void Demo::DrawColoredLemari()
{
	...
	//Body Lemari
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(5.4, 1.5, -3));
	model = glm::scale(model, glm::vec3(1, 4.3, 3.5));
...
//-----------BUILD DEPAN LEMARI
void Demo::BuildColoredDepanLemari() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("depanLemari.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredDepanLemari()
{
	glUseProgram(shaderProgram);
	...
	//Body Lemari
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(4.85, 1.5, -3));
	model = glm::scale(model, glm::vec3(0.01, 4.3, 3.5));
...
//-----------BUILD LUKISAN 1
void Demo::BuildColoredLukisan1() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("lukisan1.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredLukisan1()
{
	...
	//Lukisan 1
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-3.95, 3, -4));
	model = glm::scale(model, glm::vec3(0.01, 3, 5));
...
//-----------BUILD LUKISAN 2
void Demo::BuildColoredLukisan2() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("lukisan2.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredLukisan2()
{
	...
	//Lukisan 2
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(3.5, 3, 2.49));
	model = glm::scale(model, glm::vec3(3.3, 5, 0.01));
...
void Demo::DrawColoredKarpet()
{
	...
	//Karpet
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0, -0.5, -4));
	model = glm::scale(model, glm::vec3(5, 0.1, 3));
...
void Demo::DrawColoredLampu1()
{
	...
	//Lampu Hitam
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(1, 6.3, -4.5));
	model = glm::scale(model, glm::vec3(0.3, 0.1, 0.3));
...
void Demo::BuildColoredLampu2() {
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("kepalaLampu.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
...
void Demo::DrawColoredLampu2()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(1, 6.3, -4.5));
	model = glm::scale(model, glm::vec3(0.1, 0.3, 0.1));
...
void Demo::DrawColoredDrawer()
{
	...
	//Drawer
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(2.8, 0, -11.9));
...
//-----------BUILD DRAWER TOP
void Demo::BuildColoredDrawerTop() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
...
void Demo::DrawColoredDrawerTop()
{
	glUseProgram(shaderProgram);
	...
	//Drawer Top
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(2.8, 0.78, -11.9));
	model = glm::scale(model, glm::vec3(1, 0.05, 1));
...
void Demo::BuildColoredPlane()
{
	...
	int width, height;
	unsigned char* image = SOIL_load_image("floorwood.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
...
int main(int argc, char** argv) {
	...
	app.Start("Project Akhir Grafkom A", 1920, 1080, false, true);
}
